...
namespace MP
{
  class GRunCentralizedPlanner : public GManager
  {
  public:
    enum
    {
    ...
    GRunCentralizedPlanner(void) : GManager()
    {
      m_timer   = 50;
    ...
    virtual ~GRunCentralizedPlanner(void)
    {
    ...
    Flags                 m_flags;
    MPCentralizedPlanner       m_planner;
    int                   m_pos;
...
extern "C" int GRunCentralizedPlanner(int argc, char **argv)
{
  MP::GRunCentralizedPlanner gManager;
